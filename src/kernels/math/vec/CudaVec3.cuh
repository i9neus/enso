...
{		
    ...
    __host__ __device__ __forceinline__ vec3 saturate(const vec3& v, const vec3& a, const vec3& b) { return { clamp(v.x, 0.0f, 1.0f), clamp(v.y, 0.0f, 1.0f), clamp(v.z, 0.0f, 1.0f) }; }
